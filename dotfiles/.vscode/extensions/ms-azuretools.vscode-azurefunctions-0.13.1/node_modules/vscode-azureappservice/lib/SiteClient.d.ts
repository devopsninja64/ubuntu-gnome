import { AppServicePlan, FunctionEnvelopeCollection, FunctionSecrets, Site, SiteConfigResource, SiteLogsConfig, SiteSourceControl, SourceControlCollection, StringDictionary, User, WebAppInstanceCollection } from 'azure-arm-website/lib/models';
...
export declare class SiteClient {
    ...
    getFunctionsAdminToken(): Promise<string>;
