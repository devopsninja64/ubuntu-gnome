...
const AppSettingsTreeItem_1 = require("./AppSettingsTreeItem");
class AppSettingTreeItem extends vscode_azureextensionui_1.AzureTreeItem {
    ...
    edit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.value = newValue;
            yield this.parent.editSettingItem(this.key, this.key, newValue);
            yield this.refresh();
        });
    }
    rename() {
        return __awaiter(this, void 0, void 0, function* () {
            const settings = yield this.parent.ensureSettings();
            const oldKey = this.key;
            const newKey = yield extensionVariables_1.ext.ui.showInputBox({
                prompt: `Enter a new name for "${oldKey}"`,
                value: this.key,
                validateInput: (v) => AppSettingsTreeItem_1.validateAppSettingKey(settings, v, oldKey)
            });
            this.key = newKey;
            yield this.parent.editSettingItem(oldKey, newKey, this.value);
            yield this.refresh();
        });
    }
    deleteTreeItemImpl() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.parent.deleteSettingItem(this.key);
        });
    }
}
