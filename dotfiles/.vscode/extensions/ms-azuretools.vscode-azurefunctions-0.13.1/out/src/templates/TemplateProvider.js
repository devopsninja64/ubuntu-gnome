        ...
        for (const key of Object.keys(this._templatesMap)) {
            ...
            if (templates) {
                ...
                for (const csharpTemplate of csharpTemplates) {
                    const jsTemplate = jsTemplates.find((t) => normalizeId(t.id) === normalizeId(csharpTemplate.id));
                    if (jsTemplate) {
...
function normalizeId(id) {
    const match = id.match(/[a-z]+Trigger/i);
            ...
            for (const key of Object.keys(constants_1.ProjectRuntime)) {
                ...
                yield vscode_azureextensionui_1.callWithTelemetryAndErrorHandling('azureFunctions.getFunctionTemplates', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (!extensionVariables_1.ext.templateSource && extensionVariables_1.ext.context.globalState.get(templateRetriever.getCacheKey(TemplateRetriever_1.TemplateRetriever.templateVersionKey, runtime)) === templateVersion) {
                        ...
                        // tslint:disable-next-line:strict-boolean-expressions
                        if ((!extensionVariables_1.ext.templateSource || extensionVariables_1.ext.templateSource === extensionVariables_1.TemplateSource.CliFeed || extensionVariables_1.ext.templateSource === extensionVariables_1.TemplateSource.StagingCliFeed) && !templates && cliFeedJson && templateVersion) {
                        ...
                        // tslint:disable-next-line:strict-boolean-expressions
                        if (!extensionVariables_1.ext.templateSource && !templates) {
                            templates = yield templateRetriever.tryGetTemplatesFromCache(this, runtime);
                            this.properties.templateSource = 'mismatchCache';
                        }
                        // 4. Use backup templates shipped with the extension
                        // tslint:disable-next-line:strict-boolean-expressions
                        if ((!extensionVariables_1.ext.templateSource || extensionVariables_1.ext.templateSource === extensionVariables_1.TemplateSource.Backup) && !templates) {
