...
function getLocalFuncCoreToolsVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        const output = yield cpUtils_1.cpUtils.executeCommand(undefined, undefined, extensionVariables_1.ext.funcCliPath, '--version');
...
function addLocalFuncTelemetry(actionContext) {
    actionContext.properties.funcCliVersion = 'unknown';
    // tslint:disable-next-line:no-floating-promises
    getLocalFuncCoreToolsVersion().then((version) => {
...
exports.addLocalFuncTelemetry = addLocalFuncTelemetry;
