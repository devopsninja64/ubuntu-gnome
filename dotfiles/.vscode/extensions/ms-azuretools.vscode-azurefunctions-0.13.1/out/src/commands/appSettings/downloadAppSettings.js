...
function downloadAppSettings(node) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!node) {
            node = (yield extensionVariables_1.ext.tree.showTreeItemPicker(vscode_azureappservice_1.AppSettingsTreeItem.contextValue));
        }
        ...
        yield node.runWithTemporaryDescription(localize_1.localize('downloading', 'Downloading...'), () => __awaiter(this, void 0, void 0, function* () {
            ...
            let localSettings = yield LocalAppSettings_1.getLocalSettings(localSettingsPath, true /* allowOverwrite */);
