...
function remoteDebugFunctionApp(node) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const debugProxy = new DebugProxy_1.DebugProxy(extensionVariables_1.ext.outputChannel, client, portNumber, publishCredential);
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (needUpdateSiteConfig(siteConfig) || (appSettings.properties && needUpdateAppSettings(appSettings.properties))) {
                        ...
                        const result = yield extensionVariables_1.ext.ui.showWarningMessage(confirmMsg, { modal: true }, vscode_azureextensionui_1.DialogResponses.yes, vscode_azureextensionui_1.DialogResponses.learnMore, vscode_azureextensionui_1.DialogResponses.cancel);
                        if (result === vscode_azureextensionui_1.DialogResponses.learnMore) {
                            yield opn('https://aka.ms/azfunc-remotedebug');
                            return;
                        }
                        else {
                            yield updateSiteConfig(extensionVariables_1.ext.outputChannel, client, p, siteConfig);
                            yield updateAppSettings(extensionVariables_1.ext.outputChannel, client, p, appSettings);
                        }
                    }
                    p.report({ message: 'starting debug proxy...' });
                    extensionVariables_1.ext.outputChannel.appendLine('starting debug proxy...');
