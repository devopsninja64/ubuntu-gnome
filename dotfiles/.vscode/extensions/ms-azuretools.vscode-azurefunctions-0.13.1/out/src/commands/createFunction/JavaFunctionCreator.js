...
class JavaFunctionCreator extends FunctionCreatorBase_1.FunctionCreatorBase {
    ...
    promptForSettings(ui, functionName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!functionName) {
                const defaultFunctionName = yield fsUtil.getUniqueJavaFsPath(this._functionAppPath, this._packageName, `${TemplateProvider_1.removeLanguageFromId(this._template.id)}Java`);
