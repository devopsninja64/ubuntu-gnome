...
function startStreamingLogs(treeItem) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!treeItem) {
            treeItem = (yield extensionVariables_1.ext.tree.showTreeItemPicker(ProductionSlotTreeItem_1.ProductionSlotTreeItem.contextValue));
        }
        const client = treeItem.root.client;
        const verifyLoggingEnabled = () => __awaiter(this, void 0, void 0, function* () {
            const logsConfig = yield client.getLogsConfig();
            if (!isApplicationLoggingEnabled(logsConfig)) {
                const message = localize_1.localize('enableApplicationLogging', 'Do you want to enable application logging for "{0}"?', client.fullName);
                ...
                yield client.updateLogsConfig(logsConfig);
            }
        });
        yield appservice.startStreamingLogs(treeItem.root.client, verifyLoggingEnabled, treeItem.logStreamLabel, treeItem.logStreamPath);
    });
}
