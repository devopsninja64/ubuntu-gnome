...
class CSharpProjectCreator extends ProjectCreatorBase_1.ProjectCreatorBase {
    constructor() {
        super(...arguments);
    ...
    onCreateNewProject() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.runtime = this.runtime || (yield tryGetLocalRuntimeVersion_1.tryGetLocalRuntimeVersion()) || (yield ProjectSettings_1.promptForProjectRuntime());
            const identity = `Microsoft.AzureFunctions.ProjectTemplate.CSharp.${this.runtime === constants_1.ProjectRuntime.v1 ? '1' : '2'}.x`;
            const functionsVersion = this.runtime === constants_1.ProjectRuntime.v1 ? 'v1' : 'v2';
            yield executeDotnetTemplateCommand_1.executeDotnetTemplateCommand(this.runtime, this.functionAppPath, 'create', '--identity', identity, '--arg:name', cpUtils_1.cpUtils.wrapArgInQuotes(projectName), '--arg:AzureFunctionsVersion', functionsVersion);
        });
    }
    getTasksJson() {
        return {
            ...
            configurations: [
                {
                    ...
                    type: this.runtime === constants_1.ProjectRuntime.v2 ? 'coreclr' : 'clr',
                    request: 'attach',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (matches === null || matches.length < 1) {
                ...
                if (/net(standard|core)/i.test(targetFramework)) {
                    ...
                    this.runtime = constants_1.ProjectRuntime.v1;
                    ...
                    if (ProjectSettings_1.getFuncExtensionSetting(settingKey)) {
                        ...
                        try {
                            const result = yield extensionVariables_1.ext.ui.showWarningMessage(message, vscode_azureextensionui_1.DialogResponses.learnMore, vscode_azureextensionui_1.DialogResponses.dontWarnAgain);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!constants_1.isWindows) { // No need to validate on Windows - it should work with previous versions
                try {
                    ...
                    this.actionContext.properties.cSharpFuncSdkError = vscode_azureextensionui_1.parseError(err).message;
    ...
    confirmOverwriteExisting(functionAppPath, csProjName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingFiles.length > 0) {
                yield extensionVariables_1.ext.ui.showWarningMessage(localize_1.localize('overwriteExistingFiles', 'Overwrite existing files?: {0}', existingFiles.join(', ')), { modal: true }, vscode_azureextensionui_1.DialogResponses.yes, vscode_azureextensionui_1.DialogResponses.cancel);
                return true;
            }
            else {
                return false;
