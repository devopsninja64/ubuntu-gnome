...
function updateGlobalSetting(section, value) {
    return __awaiter(this, void 0, void 0, function* () {
        const projectConfiguration = vscode_1.workspace.getConfiguration(constants_1.extensionPrefix);
...
function updateWorkspaceSetting(section, value, fsPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const projectConfiguration = vscode_1.workspace.getConfiguration(constants_1.extensionPrefix, vscode_1.Uri.file(fsPath));
...
function getGlobalFuncExtensionSetting(key, prefix = constants_1.extensionPrefix) {
...
function getFuncExtensionSetting(key, fsPath) {
    const projectConfiguration = vscode_1.workspace.getConfiguration(constants_1.extensionPrefix, fsPath ? vscode_1.Uri.file(fsPath) : undefined);
